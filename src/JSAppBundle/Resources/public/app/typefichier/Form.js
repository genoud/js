 ...
 */
Ext.define("JS.typefichier.Form", {
    ...
    afterRenderTpl: function () {
        ...
        var form = Ext.create("Xfr.Component", {
            ...
            dynamicTpl: false,
            tplUrl: Routing.generate("get_typefichier", {
                id: id,
                _format: 'html'
            }),
            syncTplLoading: false,
            cache:false,
            renderTo: "typefichier-form-place",
            listeners: {
                "loadtpl": {
                    scope: me,
                    fn: "onLoadFormTpl"
    ...
    handleForm:function(){
        ...
        $.ajax({
            url: Routing.generate('post_typefichier', {
                _format: 'json',
                id: id,
            }),
            cache: false,
            ...
            success: function (response, textStatus, jqXHR) {
                ...
                if(response && response.success){
                    ...
                    if(id>0){
                        parent.editTypefichier(response.data);
                    }
                    else{
                        parent.addTypefichier(response.data);
                    }
