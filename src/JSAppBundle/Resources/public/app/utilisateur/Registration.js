 ...
 */
Ext.define('JS.utilisateur.Registration',{
    ...
    config:{
        ...
        panelData: {
            formUrl: Routing.generate("get_registration", { _format: 'html'})
        },
        listeners: {
            "loadtpl": {
                fn: "onLoadFormTpl"
    ...
    afterFormTplRendered:function(){
        ...
        $("#auteur_utilisateur_roles").parent().hide();
    ...
    onFormSubmit:function(){
        ...
        var opts = {
            url: Routing.generate("post_registration",{ _format: 'json'}),
            cache: false,
            contentType: false,
            processData: false,
            data: formData,
