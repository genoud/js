 ...
 */
Ext.define("JS.utilisateur.Form", {
    ...
    afterRenderTpl: function () {
        ...
        var form = Ext.create("Xfr.Component", {
            ...
            dynamicTpl: false,
            tplUrl: Routing.generate("get_utilisateur", {
                id: id,
                _format: 'html'
            }),
            syncTplLoading: false,
            cache:false,
            renderTo: "utilisateur-form-place",
            listeners: {
                "loadtpl": {
                    scope: me,
                    fn: "onLoadFormTpl"
    ...
    afterFormTplRendered:function(){
        console.log('After Form TPL rendered Utilisateur');
    ...
    handleForm:function(){
        ...
        $.ajax({
            url: Routing.generate('post_utilisateur', {
                _format: 'json',
                id: id,
            }),
            cache: false,
            ...
            success: function (response, textStatus, jqXHR) {
                ...
                if(response && response.success){
                    ...
                    if(id>0){
                        parent.editUtilisateur(response.data);
                    }
                    else{
                        parent.addUtilisateur(response.data);
                    }
